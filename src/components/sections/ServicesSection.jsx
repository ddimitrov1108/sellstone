...
const servicesArr = [
  ...
  },
  {
    ...
    description:
      "Възможността за прецизно таргетиране и лесния достъп до потенциалните ви клиенти превръща маркетинга в социалните мрежи във ваш верен помощник в изграждането на разпознаваемост и налагането на бранда ви.",
  },
  {
    id: uuidv4(),
    name: "Уеб SEO",
