  ...
  return (
    <div className="hidden-section project-card group relative w-full flex flex-col-reverse md:flex-row md:odd:flex-row-reverse md:even:text-right">
      <div className="project-card-title z-30 md:absolute md:top-0 lg:top-4 xl:top-12 md:group-odd:left-24 md:group-even:right-24">
        ...
        <div className="project-card-info rounded-md sm:shadow-lg text-sm lg:text-base min-w-full text-black-main md:max-w-[420px] lg:max-w-[520px] xl:max-w-[600px] md:p-4 md:bg-secondary">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="overflow-hidden project-card-img relative rounded-md md:max-w-[50%] h-auto"
        tabIndex={-1}
      >
        <LazyLoadImage
