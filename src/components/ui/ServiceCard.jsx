export default function ServiceCard({ service = null }) {
  return (
    <div className="bg-black-dark/30 sm:shadow-md sm:shadow-black-light/10 hidden-section service-card select-none transition-all duration-300 gap-6 grid items-center justify-center p-6 rounded-md w-full md:max-w-[330px] lg:max-w-[330px]">
