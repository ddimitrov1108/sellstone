export default function ServiceCard({ service = null }) {
  return (
    <div className="service-card select-none transition-all gap-6 grid items-center justify-center sm:p-8 bg-white rounded-md w-full min-h-[460px] md:max-w-[330px] lg:max-w-[360px] sm:shadow-lg border border-transparent md:hover:border-gold-main">
